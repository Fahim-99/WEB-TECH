...
function confirmAddDriver() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_add_Driver.php?",
    true
  );
...
function confirmDelete() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_delete_Driver.php?",
    true
  );
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("userid=" + globalid);
...
function confirmEdit() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_edit_driver.php?",
    true
  );
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send(
    "edit-did=" +
      document.getElementById("edit-did").innerHTML +
      "&edit-dname=" +
      document.getElementById("edit-dname").value +
      "&edit-demail=" +
      document.getElementById("edit-demail").value +
      "&edit-dcontact=" +
      document.getElementById("edit-dcontact").value +
      "&edit-daddress=" +
      document.getElementById("edit-daddress").value +
      "&edit-dlicense=" +
      document.getElementById("edit-dlicense").value +
      "&edit-dcommission=" +
      document.getElementById("edit-dcommission").value +
      "&edit-daccount=" +
      document.getElementById("edit-daccount").value
  );
}
// Confirm Block
function confirmBlock() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_block_Driver.php?",
    true
  );
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("userid=" + globalid);
...
function confirmUnblock() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_unblock_Driver.php?",
    true
  );
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("userid=" + globalid);
...
function deleteDriver(userid, userimage) {
  ...
  document.getElementById("deletepara").innerHTML =
    "Do you wand to delete ID: " + userid;
  document
    .getElementById("delete-userimg")
    .setAttribute("src", "../profile_image/" + userimage);
  globalid = userid;
}
//block
function blockDriver(userid, userimage) {
  blockmodal.style.display = "block";
  document.getElementById("block-para").innerHTML =
    "Do you wand to Block ID: " + userid;
  document
    .getElementById("block-userimg")
    .setAttribute("src", "../profile_image/" + userimage);
  globalid = userid;
}
//unblock
function unblockDriver(userid, userimage) {
  ...
  document.getElementById("unblock-para").innerHTML =
    "Do you wand to unblock ID: " + userid;
  document
    .getElementById("unblock-userimg")
    .setAttribute("src", "../profile_image/" + userimage);
  globalid = userid;
}
//edit
function editDriver(
  ...
  document
    .getElementById("edit-dcommission")
    .setAttribute("value", dcommission);
  document.getElementById("edit-daccount").setAttribute("value", daccount);
  document
    .getElementById("edit-userimg")
    .setAttribute("src", "../profile_image/" + dimage);
}
// //Search
