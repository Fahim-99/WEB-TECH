...
function confirmDelete() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_delete_passenger.php?",
    true
  );
...
function confirmEdit() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_edit_passenger.php?",
    true
  );
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send(
    "edit-pid=" +
      document.getElementById("edit-pid").innerHTML +
      "&edit-pname=" +
      document.getElementById("edit-pname").value +
      "&edit-pemail=" +
      document.getElementById("edit-pemail").value +
      "&edit-pcontact=" +
      document.getElementById("edit-pcontact").value +
      "&edit-paddress=" +
      document.getElementById("edit-paddress").value
  );
}
// Confirm Block
function confirmBlock() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_block_passenger.php?",
    true
  );
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("userid=" + globalid);
...
function confirmUnblock() {
  ...
  xmlhttp.open(
    "POST",
    "../../controller/employee/control_unblock_passenger.php?",
    true
  );
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("userid=" + globalid);
...
function editPassenger(pid, pname, pemail, pcontact, paddress, pimage) {
  ...
  document
    ...
    .setAttribute("src", "../profile_image/" + pimage);
}
//delete
